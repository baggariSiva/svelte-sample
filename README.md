...
<a href="https://dash.elest.io/deploy?source=cicd&social=Github&url=https://github.com/elestio-examples/svelte"><img src="public\images\deploy-on-elestio.png" alt="Deploy on elest.io" width="180px" /></a>
...
But for this Svelte website example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the Svelte-example repo otherwise you can directly insert a git repo URL to deploy the Svelte website.
